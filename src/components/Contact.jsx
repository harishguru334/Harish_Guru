    ...
    <>
      <section id="contact" className={styles.section}>
        ...
        <p className={styles.desc}>
          I'm currently open to internship opportunities. Whether you have a role in mind,
          a project to collaborate on, or just want to say hi — my inbox is always open!
        </p>
        <a href="mailto:harishgarg334@gmail.com" className={styles.btn}>
          Say Hello ✉️
        </a>
        <div className={styles.socialRow}>
          <a
            href="https://github.com/harishguru334"
          ...
          <a
            href="https://www.linkedin.com/in/harish-guru-a77a50224/"
            className={styles.socialLink}
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a href="mailto:harishgarg334@gmail.com" className={styles.socialLink}>
      ...
      <footer className={styles.footer}>
        Designed & built by Harish Guru · 2024
      </footer>
    </>
  );
}
